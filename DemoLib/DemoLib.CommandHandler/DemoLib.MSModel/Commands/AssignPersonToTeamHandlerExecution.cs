...
namespace Siemens.Mom.Presales.Training.MasterData.DemoLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class AssignPersonToTeamHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return AssignPersonToTeamHandler((AssignPersonToTeam)command);
        }
        ...
        {
            return typeof(AssignPersonToTeam);
        }
    }
}
